...
<body>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12" id="mapbox">
                <div id="style-selector-control" class="map-control">
                    ...
                    <button onclick="toggleTypeMap('road')" class="btn btn-default3"><i class="fa fa-road" aria-hidden="true"></i></button>
                ...
                <div class="pb-sys text-center">
                    ...
                    <button onclick="soundClick(); $('#helpModal').modal('show');" class="btn btn-default2 disabled" title="<?=$locale['help'];?>"><i class="fa fa-question" aria-hidden="true"></i></button>
                </div>
    ...
    <script>
        ...
        <?php
            ...
            echo 'var mapkey = "'.getOneKey($mapkeys).'";';
        ?>
    </script>
